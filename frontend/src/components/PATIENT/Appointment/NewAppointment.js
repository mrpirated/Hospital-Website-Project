...
export default function NewAppointment(props) {
    ...
    useEffect(() => {
        if(props.location.state !== undefined && props.location.state.case_details !== undefined){
    ...
    function handleSubmit(event) {   
        ...
        const start_time = format(dateOfAppointment, 'yyyy-MM-dd') + " " + startTime + ":00";
        const end_time = format(dateOfAppointment, 'yyyy-MM-dd') + " " + endTime + ":00";
            ...
            <div className="NewCase">
                ...
                <Form onSubmit={handleSubmit}>
                    <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                        ...
                        <Form.Control type="text" value={caseDetails.case_id} disabled={true}/>
                    </Form.Group>
                    ...
                    <Row>
                        <Form.Group as={Col}>
                            ...
                            <DatePicker selected={dateOfAppointment} onChange={(date) => setDateOfAppointment(date)} minDate={new Date()}/>
                        </Form.Group>
                        <Form.Group as={Col}>
