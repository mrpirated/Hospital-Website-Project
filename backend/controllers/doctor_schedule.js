    ...
    try {
        ...
        if (decodedData == undefined) {
            ...
            for (let index = 0; index < req.body.schedule.length; index++) {
                var start_time = String(req.body.schedule_date) + " " + String(req.body.schedule[index].start_time);
                var end_time = String(req.body.schedule_date) + " " + String(req.body.schedule[index].end_time);
